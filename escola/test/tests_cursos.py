...
class CursoTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.curso_1 = Curso.objects.create(
            codigo_curso='CTT1', descricao_curso='Curso teste 1', nivel_curso='B'
        )
        self.curso_2 = Curso.objects.create(
            codigo_curso='CTT2', descricao_curso='Curso teste 2', nivel_curso='A'
        )
    ...
    def test_requisicao_put_para_atualizar_curso(self):
        ...
        data = {
            'codigo_curso': 'CTT3',
            'descricao_curso': 'Curso teste 1 atualizado',
            'nivel_curso': 'A'
        }
